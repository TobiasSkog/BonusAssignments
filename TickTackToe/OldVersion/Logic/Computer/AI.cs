...
namespace BonusAssignments.TickTackToe.OldVersion.Logic.Computer
{
    public static class AI
    {
        ...
        private static int Minimax(Board gameBoard, int depth, int maxDepth, bool isMaximizingPlayer, int alpha, int beta, string computerPiece, string playerPiece)
        {
            ...
            if (isMaximizingPlayer)
            {
                ...
                // Console.WriteLine($"RETURNING MAXIMIZING BEST: {best}");
                return best;
            }
            else
            {
                ...
                //  Console.WriteLine($"returning minizing best: {best}");
                return best;
            }
        }
